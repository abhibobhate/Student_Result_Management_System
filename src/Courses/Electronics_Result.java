 ...
 */
public class Electronics_Result extends javax.swing.JFrame {

    /**
     * Creates new form Electronics_Result
     */
    public Electronics_Result() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Back1.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        Back1.setText("Back");
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select * from btech_cs where rollno='"+roll+"'");
            if(rs.next()){
                setVisible(false);
                new Electronics_Result_Data(roll).setVisible(true);
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Electronics_Result.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Electronics_Result().setVisible(true);
            }
        });
    }
