 ...
 */
public class CS_Result extends javax.swing.JFrame {

    /**
     * Creates new form CS_Result
     */
    public CS_Result() {
        initComponents();
    }
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                setVisible(false);
                new CS_Result_Data(roll).setVisible(true);
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CS_Result.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
